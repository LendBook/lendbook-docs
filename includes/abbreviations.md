*[base]: In a market pair, the base asset is the first asset. In LendBook, borrowers deposit base asset as collateral (e.i. in ETH/USDC market, the base asset is ETH)
